...
from dataLoader import BothTransformsLoader
...
train_loaders , val_loaders = BothTransformsLoader()

# Best model parameters
best_model_path = 'v1_BothTransforms_DevelopmentalCurriculum.pth'
...
plt.title("Train and Validation Accuracy with Both Transforms")
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend()
...
plt.title("Train and Validation Loss with Both Transforms")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
...
plot_path = "BothTransforms_DevelopmentalCurriculum_epochs_plot.png"
