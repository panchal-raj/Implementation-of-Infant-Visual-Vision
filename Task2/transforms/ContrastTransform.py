...
from dataLoader import ContrastTransformLoader
...
train_loaders , val_loaders = ContrastTransformLoader()

# Best model parameters
best_model_path = 'v4_onlyContrastTransform_DevelopmentalCurriculum.pth'
...
plt.title("Train and Validation Accuracy with Contrast Transfrom")
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend()
...
plt.title("Train and Validation Loss with Contrast Transfrom")
plt.xlabel("Epochs")
plt.ylabel("Loss")
plt.legend()
